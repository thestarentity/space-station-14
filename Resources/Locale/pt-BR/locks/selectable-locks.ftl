...
selectable-lock-tool-prying-verb = Ferramenta de Trava (Pé de Cabra)
selectable-lock-tool-prying-popup = Foi adicionada uma trava de pé de cabra a { THE($target) }.
