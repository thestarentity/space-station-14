...
cargo-funding-alloc-console-label-primary-cut = Parte da carga dos fundos de fontes não cofre (%):
cargo-funding-alloc-console-label-lockbox-cut = Parte da carga das vendas do cofre (%):
