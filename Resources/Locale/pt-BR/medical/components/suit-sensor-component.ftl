...
suit-sensor-mode-state = Sensores da roupa: { $mode }
...
suit-sensor-examine-off = Seus sensores parecem estar [color=darkred]desativados[/color].
suit-sensor-examine-binary = Seus sensores de vida binários parecem estar ativados.
suit-sensor-examine-vitals = Seu monitor de vitais parece estar ativado.
suit-sensor-examine-cords = Seu rastreador vital e o transmissor de localização parecem estar ativados.
