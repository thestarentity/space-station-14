...
pda-bound-user-interface-lock-uplink-title = Trancar Uplink
pda-bound-user-interface-lock-uplink-description = Impede que qualquer um acesse seu uplink sem o código
comp-pda-ui-menu-title = PDA
comp-pda-ui-footer = Assistente Pessoal Digital
