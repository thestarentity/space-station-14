...
lobby-state-song-no-song-text = Nenhuma música da sala de espera está tocando.
...
lobby-state-playtime-comment-normal =
    Você passou { $hours } { $hours ->
        [1] hora
       *[other] horas
    } jogando hoje. Lembre-se de fazer pausas!
lobby-state-playtime-comment-concerning = Você jogou por { $hours } horas hoje. Por favor, faça uma pausa.
lobby-state-playtime-comment-grasstouchless = { $hours } horas. Considere desligar para atender às suas necessidades.
