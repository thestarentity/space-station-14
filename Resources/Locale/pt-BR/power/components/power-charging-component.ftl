...
power-charge-window-power = Potência:
power-charge-window-eta = ETA:
power-charge-window-charge = Carga:

## UI statuses

power-charge-window-status-fully-charged = Completamente Carregado
...
power-charge-window-eta-none = Valor inválido.
