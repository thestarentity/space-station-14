comp-gas-canister-ui-canister-status = Status do Canister
...
comp-gas-canister-ui-holding-tank-status = Status do Tanque de Armazenamento
...
comp-gas-canister-ui-holding-tank-eject = Expulsar
comp-gas-canister-ui-release-valve-status = Status da Válvula de Liberação
comp-gas-canister-ui-release-pressure = Libera Pressão (kPa):
comp-gas-canister-ui-release-valve = Válvula de Liberação:
comp-gas-canister-ui-release-valve-open = Aberto
comp-gas-canister-ui-release-valve-close = Fechar válvula de liberação
