...
comp-secret-stash-action-get-item-found-something = Tinha algo dentro do { $stashname }!
comp-secret-stash-on-examine-found-hidden-item = Tem algo escondido dentro do { $stashname }!
