...
ent-ActionGoliathTentacle = [color=red]Soco com tentáculo[/color]
    .desc = Use suas tentáculos para agarrar e atordoar um jogador alvo!
...
ent-FoodHivelordRemainsInert = restos do hivelord inativo
    .desc = Tudo que resta de um hivelord... Agora tudo está realmente perdido.

ent-MobBasilisk = basilisco
    .desc = Um animal territorial, coberto por uma concha grossa que absorve energia. Seu olhar faz as vítimas congelarem por dentro.
