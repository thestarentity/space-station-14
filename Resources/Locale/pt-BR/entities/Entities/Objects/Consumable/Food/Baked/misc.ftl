...
ent-FoodBakedBunHoney = pão de mel
    .desc = Um pãozinho de mel com glaceado de mel.

ent-FoodBakedBunHotX = pão de hortelã quente
    .desc = Um pão de mel pegajoso coberto com uma cruz branca distintiva.
...
ent-FoodBakedCookieOatmeal = biscoito de aveia
    .desc = O melhor dos dois lados: biscoito e aveia.

ent-FoodBakedCookieRaisin = biscoito com passas
    .desc = Por que colocaria passas em um biscoito?

ent-FoodBakedCookieSugar = biscoito de açúcar
    .desc = Assim como sua mãe costumava fazer.
...
ent-FoodBakedPancakeBb = panqueca de mirtilo
    .desc = Um panqueca fofo e delicioso com mirtilos.
...
ent-FoodBakedChevreChaud = chèvre chaud
    .desc = Um disco de chèvre ligeiramente derretido foi jogado sobre um crostini e torrado por todos os lados.

ent-FoodBakedChevreChaudCotton = chèvre chaud de algodão
    .desc = Um disco de chèvre ligeiramente derretido caiu sobre um... crostini de algodão e foi torrado por todos os lados.

ent-FoodBakedBrownieBatch = brownies
    .desc = Uma panela de brownies.

ent-FoodBakedBrownie = brownie
    .desc = Um brownie fresco assado.

ent-FoodBakedCannabisBrownieBatch = brownies de canabissão
    .desc = Uma panela de "especiais" brownies.
...
ent-FoodBakedCroissantCotton = croissant de algodão
    .desc = Bolos crocantes, crocantes e fibrosos com sabor a manteiga.

ent-FoodBakedGrilledCheeseSandwich = sanduíche de queijo grelhado
    .desc = Pão e queijo torrados com manteiga, perfeito para um dia frio no espaço.
