...
ent-FoodSpacemansTrumpet = trombeta do astronauta
    .desc = A flower vibrant that smells slightly of freshly cut grass. Touching the flower seems to stain the skin some time after contact, though most other surfaces seem not to be affected by this phenomenon.
