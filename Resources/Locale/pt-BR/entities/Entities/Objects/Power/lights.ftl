...
ent-LedLightBulb = lâmpada de LED
    .desc = Uma lâmpada de energia eficiente.

ent-DimLightBulb = lâmpada de luz fraca
    .desc = Uma lâmpada fraca para iluminar a escuridão da manutenção.

ent-WarmLightBulb = lâmpada quente
    .desc = Uma lâmpada quente para um ambiente mais acolhedor.

ent-LightBulbOld = velha lâmpada incandescente
    .desc = Um lâmpada velha.

ent-LightBulbBroken = lâmpada incandescente
    .desc = Uma lâmpada.

ent-ServiceLightBulb = lâmpada de serviço
    .desc = Um lâmpada de baixa luminosidade verde usada nas luzes dos serviços de zeladoria.

ent-LightTube = tubo de luz fluorescente
    .desc = Um dispositivo de iluminação.

ent-LightTubeOld = velha lâmpada fluorescente
    .desc = Um dispositivo de luz antigo.
