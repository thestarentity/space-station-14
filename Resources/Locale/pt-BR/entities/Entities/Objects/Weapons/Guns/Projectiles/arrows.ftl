ent-ArrowRegular = seta
    .desc = Você pode sentir a força da esteppe dentro de você.

ent-ArrowImprovised = flecha de fragmento de vidro
    .desc = O projétil preferido do greyshirt.

ent-ArrowImprovisedPlasma = flecha de fragmento de vidro de plasma
    .desc = O projétil preferido do greyshirt. Agora com letalidade extra!
