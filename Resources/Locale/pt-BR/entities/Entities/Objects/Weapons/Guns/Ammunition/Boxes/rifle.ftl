ent-MagazineBoxRifleBig = caixa de munição (.20 rifle)
...
ent-MagazineBoxRifleIncendiary = caixa de munição (.20 rifle incendiário)
    .desc = Uma caixa de cartão com munição para rifle .20. Intendida para conter munição incendiária autoligante.

ent-MagazineBoxRifleUranium = caixa de munição (.20 rifle urânio)
    .desc = Uma caixa de cartão com munição para rifle .20. Intendida para conter munição exótica com núcleo de urânio.
