...
ent-JetpackCaptainFilled = jetpack do capitão
    .desc = É um jetpack. Ele pode conter 5 L de gás.
ent-JetpackMini = jetpack mini
    .desc = É um jetpack. Ele pode conter 1,5 L de gás.

ent-JetpackMiniFilled = jetpack mini
    .desc = É um jetpack. Ele pode conter 1,5 L de gás.
ent-JetpackSecurity = jetpack de segurança mini
    .desc = Um jetpack compacto utilizado pela segurança da estação ao patrulhar o exterior da estação. Não foi projetado para viagens de longa distância, possui apenas 1,5 L de gás.
