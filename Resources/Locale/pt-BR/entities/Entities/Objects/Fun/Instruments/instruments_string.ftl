ent-ElectricGuitarInstrument = guitarra elétrica
    .desc = Agora você se sente como um verdadeiro roqueiro!

ent-BassGuitarInstrument = baixo elétrico
    .desc = Você se sente muito legal segurando isso. Pena que você seja o único que pensa assim.
