...
ent-FloorTileItemKitchen = azulejo da cozinha
...
ent-FloorTileItemIronsandConcreteMono = tijolo de concreto mono com areia de ferro
...
ent-FloorTileItemAstroIce = Gelo Astral
    .desc = Gelo falso tão escorregadio quanto o verdadeiro, mas fácil de remover!
...
ent-FloorTileItemUraniumMarble = Azulejo de mármore de urânio
    .desc = Uma pedra quadrada trabalhada e polida feita do mais fino Space Marble. Infundida com urânio para torná-la ainda mais rad! Brincadeira de mau gosto!

ent-FloorTileItemXeno = piso xenomorfo

ent-FloorTileItemXenoSteel = piso de aço xenon

ent-FloorTileItemXenoSteelCorner = piso de aço xeno canto

ent-FloorTileItemXenoMaint = piso de manutenção de tecnologia xenonática
