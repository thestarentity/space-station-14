...
ent-PenCentcom = Caneta da CentCom
    .desc = Tentando acompanhar a "força" da burocracia do sol cibernético, a Nanotrasen fez uma réplica da caneta cibernética, no estilo corporativo.
...
ent-PenWiz = caneta mágica do feiticeiro
    .desc = Uma caneta de tinta luxuosa. Parece ter um apagador de cristal mágico.
