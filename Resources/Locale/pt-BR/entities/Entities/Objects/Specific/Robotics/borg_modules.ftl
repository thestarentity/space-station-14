...
ent-BorgModuleRescue = módulo de resgate de ciborgue
...
ent-BorgModuleEsword = módulo ciborg de espada de energia
    .desc = Um módulo de armas que vem com uma espada de energia.

ent-BorgModuleDoubleEsword = módulo ciborgue de espada de energia dupla
    .desc = Um módulo de armas que vem com uma espada de energia dupla.

ent-BorgModuleL6C = Módulo ciborgue L6C
    .desc = Um módulo de armas que vem com um L6C.

ent-BorgModuleC20r = Módulo cibernético C-20r ROW
    .desc = Um módulo de armas que vem com um C-20r de fogo em rajadas.

ent-BorgModuleMartyr = módulo ciborgue mártir
    .desc = Um módulo que vem com uma explosão que você provavelmente não quer lidar sozinho.

ent-MothershipModule = módulo da nave-mãe
    .desc = Um módulo que ajuda o cérebro borg da nave-mãe e instala outros módulos.
...
ent-XenoborgModuleTileGun = canhão de mosaico xenoborg
    .desc = Módulo com uma pistola de azulejos. espera, o que é isso?

ent-XenoborgModuleJammer = módulo de interferência xenoborg
    .desc = Módulo com um emissor de interferência.

ent-XenoborgModuleLaser = módulo laser xenoborg
    .desc = Módulo com uma arma laser.

ent-XenoborgModuleHeavyLaser = módulo xenoborg canhão laser
    .desc = Módulo com canhão laser.

ent-XenoborgModuleSpaceMovement = módulo de movimento espacial xenoborg
    .desc = Módulo que ajuda um Xenoborg a se mover melhor no espaço.

ent-XenoborgModuleJump = módulo de salto xenoborg
    .desc = Módulo que permite que um xenoborg pule para frente.

ent-XenoborgModuleSword = espada módulo xenoborg
    .desc = Módulo com uma faca de kukri.

ent-XenoborgModuleEnergySword = adaga de energia módulo xenoborg
    .desc = Módulo com uma adaga de energia.

ent-XenoborgModuleHypo = módulo xenoborg de hipnoctúrina
    .desc = Módulo com uma hipodermica de nocturina auto-recarregável.

ent-XenoborgModuleChameleonProjector = módulo xenoborg projetor camuflador
    .desc = Módulo com um projetor de camuflagem.

ent-XenoborgModuleCloakDevice = módulo xenoborg do dispositivo de camuflagem
    .desc = Módulo com um dispositivo que permite que xenoborgs fiquem semi-invisíveis por algum tempo.
