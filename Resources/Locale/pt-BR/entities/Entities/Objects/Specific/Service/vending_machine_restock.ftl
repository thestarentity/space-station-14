...
ent-VendingMachineRestockChefvend = ChefVend restock box
    .desc = Reabasteça o ChefVend. Só não quebre mais ovos.
...
ent-VendingMachineRestockCostumes = AutoDrobe restock box
    .desc = Uma panóplia de funcionários da NanoTrasen estão se divertindo em um teatro colorido em uma tragédia-comédia. Você também pode participar! Carregue isso na sua máquina de venda automática de roupas mais próxima.
...
ent-VendingMachineRestockDonut = Robust Donuts restock box
    .desc = Uma caixa cheia de pacotes toroidais de massa frita para repor uma máquina de venda automática. Use apenas conforme as instruções da Robust Industries, LLC.
...
ent-VendingMachineRestockGetmoreChocolateCorp = GetMore Chocolate restock box
    .desc = Uma caixa carregada com o melhor cacau artifical. Deverá ser usada apenas em máquinas de venda automática oficiais da Getmore Chocolate.
...
ent-VendingMachineRestockNutriMax = NutriMax restock box
    .desc = Nós vamos deixar seus dedos verdes com nossas ferramentas. Vamos começar a colher! Carregue em uma máquina de venda automática NutriMax.

ent-VendingMachineRestockPTech = PTech restock box
    .desc = Toda a burocracia que você pode lidar, e mais! Carregue no automato de vendas da PTech para começar.

ent-VendingMachineRestockRobustSoftdrinks = caixa de reposição de bebidas
    .desc = Um recipiente frio e pesado com cilindros gelados que se chocam. Utilize somente conforme as instruções da Robust Industries, LLC.

ent-VendingMachineRestockSecTech = SecTech restock box
    .desc = Cuidado, comunistas: o reforço chegou! Uma etiqueta diz PESSOAL DE SEGURANÇA APENAS.

ent-VendingMachineRestockSalvageEquipment = Salvage Vendor restock box
    .desc = Ataque a terra antes que o peixe espacial morda seu traseiro! Esbarre em um vendedor de ressarcimento para começar.
