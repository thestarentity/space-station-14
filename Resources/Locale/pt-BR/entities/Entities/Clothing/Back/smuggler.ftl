ent-ClothingBackpackSatchelSmuggler = mochila de contrabandista
    .desc = Uma mochila prática e suspeita. Suficientemente plana para caber sob os azulejos do chão.

ent-ClothingBackpackSatchelSmugglerUnanchored = mochila de contrabandista
    .desc = Uma mochila prática e suspeita. Suficientemente plana para caber sob os azulejos do chão.

ent-BriefcaseSmugglerCash = malas de contrabando
