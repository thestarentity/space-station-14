ent-MachineAnomalyVessel = navio de anomalia
    .desc = Um recipiente capaz de aproveitar uma varredura de uma anomalia e transformá-la em dados de pesquisa.

ent-MachineAnomalyVesselExperimental = navio experimental de anomalia
    .desc = Um avançado navio de anomalia capaz de oferecer maior potencial de pesquisa, ao custo de maior volatilidade e decaimento radioativo de baixo nível no ambiente.
