...
ent-HolosignSecurity = barreira holográfica
    .desc = Uma barreira de luz dura que bloqueia o movimento, mas bastante fraca.

ent-HolosignForcefield = campo de força holográfico
    .desc = Um poderoso campo de contenção temporal que não deixa nada passar, nem mesmo um telsa ou singularidade.
