...
ent-PosterContrabandHackingGuide = Guia de Hacking
    .desc = Este pôster detalha o funcionamento interno da comum eclusa de ar da Nanotrasen. Tristemente, parece estar desatualizado.
...
ent-PosterContrabandRebelsUnite = Rebeldes, Uni-vos!
...
ent-PosterLegitBlessThisSpess = Abençoe Esta Nave
...
ent-PosterLegitFoamForceAd = Anúncio Foam Force
...
ent-PosterLegit12Gauge = calibre 12
    .desc = Um pôster que se vangloria da superioridade das munições de espingarda 12 gauge.
...
ent-PosterLegitBotanyFear = Medo de hidroponia
    .desc = Pense três vezes antes de abrir a eclusa de ar para a horticultura, uma ameaça vermelha pode estar escondida lá.
