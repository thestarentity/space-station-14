...
ent-WeldingFuelTankHighCapacity = tanque de combustível de alta capacidade
    .desc = Um tanque de combustível altamente pressurizado feito para armazenar quantidades gigantescas de combustível para solda.

ent-WaterTank = tanque de água
    .desc = Um tanque de água. É usado para armazenar grandes quantidades de água.

ent-WaterCooler = água gelada
    .desc = Parece um bom lugar para ficar e desperdiçar tempo. Ele tem um estoque de copos de papel ao lado.
