...
admin-verb-text-make-head-rev = Tornar Chefe de Revolução
admin-verb-text-make-thief = Tornar Ladrão
admin-verb-text-make-paradox-clone = Criar Clone Paradoxal
admin-verb-text-make-wizard = Tornar Mago
admin-verb-text-make-space-ninja = Tornar Ninja
