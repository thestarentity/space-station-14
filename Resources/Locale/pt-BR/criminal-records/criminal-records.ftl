...
criminal-records-status-paroled = Libertado sob liberdade condicional
criminal-records-status-hostile = Hostil
criminal-records-status-eliminated = Eliminado
criminal-records-console-wanted-reason = Motivo da Busca
criminal-records-console-suspected-reason = Motivo Suspeito
...
criminal-records-console-paroled = { $name } ({ $job }) foi liberado sob liberdade condicional por { $officer }.
criminal-records-console-not-parole = { $officer } removeu o status de liberdade condicional de { $name } ({ $job }).
criminal-records-console-hostile = { $name } ({ $job }) foi marcado como hostil por { $officer } por: { $reason }.
criminal-records-console-not-hostile = { $name } ({ $job }) não está mais marcado como hostil por { $officer }.
criminal-records-console-eliminated = { $name } ({ $job }) foi marcado como eliminado por { $officer }.
criminal-records-console-not-eliminated = { $name } ({ $job }) não está mais marcado como eliminado por { $officer }.
criminal-records-console-unknown-officer = <desconhecido>

## Filters

criminal-records-filter-placeholder = Insira o texto e pressione "Enter"
criminal-records-name-filter = Nome
criminal-records-prints-filter = Impressões digitais
criminal-records-dna-filter = DNA
criminal-records-job-filter = Cargo
