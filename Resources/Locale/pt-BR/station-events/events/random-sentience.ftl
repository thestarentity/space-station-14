...
random-sentience-event-data-4 = o tráfego de comunicações na sua estação
...
station-event-random-sentience-role-description = Você é um ser consciente { $name }, trazido à vida através da magia espacial.
# Flavors
