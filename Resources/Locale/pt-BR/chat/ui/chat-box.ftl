...
hud-chatbox-select-channel-Emotes = Expressões
...
hud-chatbox-channel-Admin = Administração
hud-chatbox-channel-AdminAlert = Alerta de Administração
hud-chatbox-channel-AdminChat = Chat do Admin
hud-chatbox-channel-Dead = Morto
hud-chatbox-channel-Emotes = Expressões
...
hud-chatbox-highlights = Destaque:
hud-chatbox-highlights-button = Enviar
hud-chatbox-highlights-tooltip =
    As palavras precisam ser separadas por uma nova linha,
    se envoltas em " elas serão destacadas
