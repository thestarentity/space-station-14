...
command-description-inventory-forcespawn = Gera um protótipo específico na primeira entidade conectada que possui um slot compatível com a bandeira fornecida, deletando qualquer item anteriormente nesse slot.
...
command-description-inventory-spawn = Gera um protótipo específico na primeira entidade conectada que possui um slot compatível com a bandeira fornecida, desequipando qualquer item anteriormente nesse slot.
...
command-description-inventory-ensurespawn = Gera um protótipo específico na primeira entidade conectada que possui um slot compatível com a bandeira fornecida; se não houver nenhum, passa o UID do que estiver no slot ao final.
