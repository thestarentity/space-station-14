...
delivery-spam-1 = Ferramenta Robusta - Oferta Especial!
    .desc = Uma propaganda por caixas de ferramentas robustas.
    .content = [color=blue][head=1]
        ░░▄▀░░
        ░▄█▄▄▀ [head=3]ROBUST - CAIXAS DE FERRAMENTAS E FERRAMENTAS[/head]
        ██▀░░░ [/head][/color]
        
        { "[bold]BUY ONE TOOLBOX, GET ONE SET OF TOOLS FOR FREE![/bold]" }
        
        COMO VOCÊ É UM DE NOSSOS CLIENTES PRECIOSOS, VOCÊ RECEBE UM BÔNUS DE CLIENTE, SUAS FERRAMENTAS VEM SEM RUSTE E CHUMBO!!! NÃO É MARAVILHOSO? A CAIXA DE FERRAMENTAS, POR OUTRO LADO, VEM COM CHUMBO ADICIONAL! MARAVILHOSO PARA QUEBRAR CRÂNIO E PARAR RADIAÇÃO AO MESMO TEMPO!
        ...
        -PREÇO BAIXO! APENAS UM ÓRGÃO! QUE É MENOS QUE DOIS ÓRGÃOS!
        -NÃO PRECISA SER SEU ÓRGÃO! NÃO JULGAMOS!
delivery-spam-2 = Motivos para escolher a Nanotrasen!
    .desc = Uma propaganda para a Nanotrasen.
    .content =
        ...
        SEUS AGENTES DORMITIVOS SÃO INCOMPETENTES! ELES NEM SABEM MATAR UM PASSAGEIRO COM UMA VONTADE DE MORRER!
        
        { "[bold]NUMBER TWO[/bold]" }
        SEUS CIDADÃOS SÃO FRACOS PARA BALAS! ACREDITE EM MIM, TENTAMOS! AO CONTRÁRIO DOS CIDADÃOS NANOTRASEN, OS CIDADÃOS DO SINDICATO MORREM COM UMA BALA NA CABEÇA! TEMOS BALAS!
        
        { "[bold]NUMBER THREE[/bold]" }
        SEU LOGOTIPO É HORRÍVEL! ELES PENSAM QUE SÃO COOL COM SEU LOGOTIPO! AH, OLHE PRA MIM, EU SOU TÃO COOL! AH, UMA SERPENTE QUE TAMBÉM É UM S! QUÃO CRIATIVO! MEU FILHO DE TRÊS ANOS PODERIA DESENHAR UM LOGOTIPO MELHOR!
delivery-spam-3 = Motivos para escolher o Sindicato!
    .desc = Uma propaganda para O Sindicato.
    .content =
        ...
        { "[bold]NUMBER ONE[/bold]" }
        OS SEUS FUSILS SÃO PÉSSIMOS! ELES NEM MESMO TÊM FUSIL DE PRIMEIRO TIRO! SUAS FORÇAS DE SEGURANÇA NEM MESMO PODEM CARREGAR ARMA DE GRANDE PORTE EM MAIORIA DAS SITUAÇÕES!
        
        { "[bold]NUMBER TWO[/bold]" }
        OS SEUS COMANDANTES? ELES MORREM COM UM ÚNICO TIRO! NENHUM ARMADURA COOL! APENAS PUM, MORTO! CHATO! NOSSOS COMANDANTES RECEBEM ARMADURAS DURA!
        
        { "[bold]NUMBER THREE[/bold]" }
        OS SEUS MÉTODOS DE MATA-MATA SÃO SEM GRANDEZA! É APENAS GUN! NÃO TEM NADA DE LANÇAR PESSOAS PARA O ESPAÇO PROFUNDO, NÃO TEM NADA DE ALIMENTAR PESSOAS EM RECICLADORES COM MODO DE SEGURANÇA DESATIVADO, NÃO TEM NADA DE BOMBAS ESCONDIDAS NAS BOLSA! TÃO CHATO!
delivery-spam-4 = Cansado de ciência explodindo?
    .desc = Siga estas simples etapas para garantir que isso nunca aconteça novamente!
    .content = [head=3]A Ciência vai AMAR você por isso!!
        
        você está [bold]CANSADO[/bold] da Departamento de Ciência da sua Estação explodindo sem fazer nenhuma ciência real?
        Bem, você está com sorte![/head]
        
        Siga este simples guia, e garantiremos que a Ciência [italic]Nunca Funcione Novamente![/italic]
        
        Basta fazer o seguinte:
        - Passo Um: Localize o Servidor de Pesquisa do Departamento de Ciência
        - Passo Dois: Desencaixe o Servidor de Pesquisa do chão
        - Passo Três: Jogue o Servidor de Pesquisa para o espaço, preferencialmente na direção do Super Dojo Espacial Secreto da Tribo Aranha
        - Passo Quatro: Espere aproximadamente 3-5 Turnos de Negócios
        - Passo Cinco: Nossos funcionários da Spid-ex Inc fornecerão à sua estação uma (1) tecnodisco por semana.
...
delivery-spam-5 = Liberte todos os AXCESS!!
    ...
    .content = [head=3]Você já quis ter [italic][color=verde]Grátis [bold]Todo Axcess!?!?[/bold][/color][/italic][/head]
        ...
        { "[/color]" }
delivery-spam-6 = AVISO DA NANOTRASEN!!
    .desc = Uma notificação oficial do CEO da Nanotrasen?!
    .content = [color=red] ESTE É UM AVISO OFICIAL DO CHEFE DE [color=blue]NANOTRASN[/color][/color]
        
        Caro Senhor, Senhora ou Outro Insignificante Pessoal da Estação
        
        Se você não deseja que esta estação seja declarada Inviável aos olhos de
        { "[head=2][italic] Our Great and Glorious [color=blue]Nanotransen[[/color][/head]" }
        Você deve organizar para que três [color=blue]Nt[/color] Pilhas Padrão de [color=blue]nt[/color] Ouro Padrão sejam enviadas para os Postos Avançados de Comércio da sua estação dentro de 5 [color=blue]nT[/color] Turnos de Trabalho Padrão.
...
delivery-spam-7 = Envie reforços!
    .desc = Um aviso oficial de... uma linha do tempo alternativa?
    .content =
        ...
        Para quem quer que receba esta carta. Sou o Sargento Rigel. Meu cargo é o CSO. Necessitamos de assistência imediata.
        
        Nossa estação está atualmente sob ataque por Agentes Atômicos, esta carta está sendo jogada em uma anomalia de bluespace instabilizada criada pelo nosso [color=purple]Diretor de Pesquisa[/color].
        
        Estou atualmente preso na Ponte de Comando, se você recebe esta mensagem, por favor envie ajuda imediatamente. Não sei por quanto tempo mais conseguiremos resistir.
        
        Glória a Nanotrasen.
delivery-spam-8 = Os Filhos de Nar'Sie
    .desc = Uma seita local está procurando recrutas.
    .content = [color=#134975][head=2]Os Filhos de Nar'Sie[/head][/color]
        ...
        Na era moderna, é fácil para almas desgarradas se sentirem como engrenagens na máquina de grandes corporações.
        
        { "[head=3]Do you feel as if you're made for a better purpose?[/head]" }
        Você se cansa da vida de mundanidade imposta a você? Limpar pisos, entregar caixas ou preencher papelada interminável?
        
        { "[head=3]Do you want to make the galaxy a better place?[/head]" }
        
        
        Se você respondeu "Sim" a qualquer uma dessas perguntas, entre em contato com um de nossos representantes hoje! Temos membros em estações por todo o universo ansiosos para acolher novos membros em nossa tribo. Seja uma das lâminas que ajudam a acolher o Geômetra do Sangue em nosso universo para que todos possam conhecer seu prazer!
        
        Tudo o que você tem a fazer é dizer [color=#FF0000][italic]"Sas'so c'arta forbici!"[/italic][/color]
delivery-spam-9 = Você quer lutar?!
    .desc = Venha experimentar a luta na nossa academia de lutas local! Treinamento gratuito para novatos, combates épico e prêmios incríveis para os vencedores. Não importa se você é um iniciante ou um especialista, aqui todos são bem-vindos! Inscreva-se hoje mesmo e torne-se um campeão!
...
delivery-spam-10 = NÃO ABRA ESTA MENSAGEM
...
delivery-spam-11 = Ajude mamãe e papai!
    ...
    .content = [bold]Olá criança,[/bold]
        Este é seu pais escrevendo para você: precisamos de dinheiro! Nossas taxas foram auditadas e devemos $100.000 em spesos ao governo! por favor, ajude! eles só querem cartões-presente, então você precisará nos enviar 100 cartões-presente de $1000 spesos.
        ...
        se não recebermos esse dinheiro em 10 dias, então o governo virá para pegar nossa casa e vamos ficar sem teto.
        
        { "[bold]thank you and we love you,[/bold]" }
        { "[italic]parents[/italic]" }
delivery-spam-12 = Venha conosco na primeira viagem!
    .desc = Anúncio para uma viagem relaxante.
    .content = [head=2]Venha conosco na primeira viagem da...[/head]
        ...
        O mais recente em Comfortech™ e as vistas mais belas deste lado do Sistema Iraxsi! O [italic]SS Relaxor[/italic] é um cruzeiro de luxo de última geração que vai levar você numa jornada inesquecível!
        ...
        Por um custo baixo, baixo de $5.000 spesos por noite, o cruzeiro de luxo de seis meses poderia ser seu para a férias dos seus sonhos! Ligue para nós hoje em [color=#00FF00]RELAX-NOW[/color] para reservar seu cruzeiro. Não espere! Aja agora!
