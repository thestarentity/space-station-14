...
ai-borg-lock = Lock cyborg
ai-borg-unlock = Unlock cyborg
...
ai-atmos-lockdown = Lock down sector (emergency)
ai-atmos-unlock = Unlock sector
station-ai-atmos-lockdown-on = Sector locked: airlocks and firelocks sealed.
station-ai-atmos-lockdown-off = Sector unlocked.
